// Reacting SVG ICON
 export const RATING = "src/images/star-logo.png";
...
export const swiggy_api_URL =
  "https://corsproxy.org/?" +
  encodeURIComponent(
    "https://www.swiggy.com/dapi/restaurants/list/v5?lat=12.9351929&lng=77.62448069999999&is-seo-homepa_type=DESKTOP_WEB_LISTING"
  );
...
// RestaurantList is JSON Data for displaying Restaurant cards
export const restaurantList = [
  {
    ...
    analytics: {
      context: "seo-data-ccdd46bb-e097-422b-a9e4-f1f7d3cb5fbd",
    },
    cta: {
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-05-05 06:55:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      id: "47449",
      name: "Tenzin Kitchen",
      cloudinaryImageId: "mpl31vrpguxhifsmdrud",
      locality: "Koramangala",
      areaName: "Koramangala",
      costForTwo: "₹400 for two",
      cuisines: ["Asian", "Chinese", "Pan-Asian", "Tibetan"],
      avgRating: 4.4,
      parentId: "21525",
      avgRatingString: "4.4",
      totalRatingsString: "10K+",
      ...
      availability: {
        nextCloseTime: "2024-05-04 16:30:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
    ...
    cta: {
      link: "https://www.swiggy.com/restaurants/tenzin-kitchen-koramangala-bangalore-47449",
      text: "RESTAURANT_MENU",
      type: "WEBLINK",
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
